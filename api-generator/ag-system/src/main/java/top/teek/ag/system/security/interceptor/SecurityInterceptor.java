package top.teek.ag.system.security.interceptor;
...
public class SecurityInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        ...
        if (Objects.nonNull(expired) && expired.getTime() - new Date().getTime() < jwtProperties.getRefreshTime()) {
            ...
            AgHelper.cacheUserInfo(loginUser, tokenExpireTime);
        }
        return true;
    }
}

package top.teek.log.aspect;

import top.teek.log.config.LogAutoConfiguration;
import top.teek.log.enumeration.RequestLogLevelEnum;
import top.teek.log.properties.RequestLogProperties;
import top.teek.utils.ClassUtil;
...
public class RequestLogAspect {
     ...
     */
    @Around(
            "execution(!static top.teek.core.http.Response *(..)) && " +
